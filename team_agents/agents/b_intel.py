...
from fastAPI.utils import cache, metrics, to_json_safe
from fastAPI.utils import get_config
from fastAPI.utils import embedder, safe_ask_llm
from fastAPI.utils import fetch_feed  # uses existing tools module
